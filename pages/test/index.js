  ...
  return (
    ...
    <div className='bg-gradient-to-l from-slate-500 to-indigo-500 w-screen '>
      ...
      <div className="flex flex-col justify-center place-items-center h-screen pt-10 rounded-xl shadow-lg'bg-gradient-to-l from-slate-500 to-indigo-500 ">
        <h2 className='text-red-500 animate-pulse pb-20 pr-20 text-3xl'>A new package Coming!</h2>
          ...
          {props.posts.map(post => (
            <div className='flex flex-col' key={post.id}>
              ...
              <div className='flex flex-row justify-around pt-10 '>
                <button onClick={togglePopup} className='text-white text-xl bg-blue-900 w-2/6 rounded-full'>Quit</button>
                <button onClick={togglePopup} className='text-xl bg-green-300 w-2/6 rounded-full '>Add to Stack</button>
                {showPopup && (
